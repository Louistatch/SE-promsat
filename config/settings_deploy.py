"""
Configuration Django pour le déploiement en production
Compatible avec Railway, Render, Heroku, etc.
"""
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@prosmat.tg')
